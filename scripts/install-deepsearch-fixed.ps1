# 🏛️ REZ HIVE - DEEP SEARCH INSTALLER (FIXED)
# ================================================
...
"@
        ...
        if ($routerContent -match '(// PRIORITY 2:.*?\n.*?\n)') {
            ...
            Write-Host "   ⚠️ Could not auto-update router - add manually:" -ForegroundColor Yellow
            Write-Host $deepSearchRule -ForegroundColor Cyan
        }
    } else {
...
# ================================================
# 5. UPDATE SAMPLE COMMANDS (Instruction)
# ================================================
Write-Host "`n📝 Add this to your SAMPLE_COMMANDS array in page.tsx:" -ForegroundColor Cyan
Write-Host '   { label: "Deep Research", icon: <Sparkles className="w-3 h-3" />, prompt: "Deep search: " },' -ForegroundColor White
...
# ================================================
# 7. UI UPDATE INSTRUCTIONS
# ================================================
Write-Host "`n🎨 UI Update Instructions:" -ForegroundColor Cyan
Write-Host ""
Write-Host "Add this to your SearchResults component in page.tsx:" -ForegroundColor Yellow
Write-Host @'
...
Write-Host ""
Write-Host "   1. Add the Deep Search command to SAMPLE_COMMANDS"
Write-Host "   2. Add the Deep Search UI component to SearchResults"
...
Write-Host ""
Write-Host "   4. Test Deep Search:" -ForegroundColor White
